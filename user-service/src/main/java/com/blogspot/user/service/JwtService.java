...
public class JwtService {
    ...
    /**
     * A generic helper method to extract a single claim from the JWT.
     */
    ...
    /**
     * Extracts all claims from the JWT. The signature is verified during this process.
     */
